...
module.exports.createUser = (req, res) => {
  ...
  bcrypt.hash(password, 10)
    ...
    .catch((err) => {
      if (err.name === 'ValidationError' || err.message === 'Illegal arguments: undefined, number' || err.message === 'Illegal arguments: undefined, string' || err.message === 'Illegal arguments:  string, undefined') {
...
module.exports.login = (req, res) => {
  ...
  return User.findUserByCredentials(email, password)
    ...
    .catch((err) => {
      if (err.message === 'Illegal arguments: undefined, string' || err.message === 'Illegal arguments:  string, undefined') {
